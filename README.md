...
## Configuration
[config.example.json](https://github.com/AustinTi/SpotGrabAPI/blob/master/config.example.json) is an example for the config. It becomes a struct as such:
```go
...
## License Notice
Make sure any and all use of this software complies with the [license](https://github.com/AustinTi/SpotGrabAPI/blob/master/LICENSE), the GNU Afferro General Public License v3.0